  ...
  return (
    <>
      <div className='mainTexta'>
        <h2>Júnior</h2>
        <p>Baseado nas 120 perguntas front-end, serão respondidas apenas 30, as de nível júnior. Contém um conjunto de perguntas relacionado a front-end e não só. As perguntas formam retiradas do github do <a href="https://github.com/rubenmarcus/120-perguntas-frontend" target="_blank">Ruben Paschoarelli.</a> Essas Perguntas têm o intuito de ser uma base para entrevistas e candidatos se nivelarem, em entrevistas de emprego. Não são necessariamente o fator decisivo da senioridade de cada candidato, porem, é sempre importante aprender.</p>
      </div>
    <main>
      <div className="accordion">
        ...
        {data.map((item, i) => (
          <div className="item">
            <div className="title" onClick={() => mudar(i)}> 
              <h3>{item.pergunta}</h3>
              <span>{selected === i ? <img src={less} alt="-" /> : <img src={add} alt="+" />}</span>
            </div>
